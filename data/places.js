...
export const places = [
  /* ============================ Kyoto ============================ */
  {
    id: "p-hikiniku", name: "Hikiniku to Come", ja: "挽肉と米", cat: "food",
  ...
  /* ============================ Osaka ============================ */
  {
    id: "p-gyukotsuo", name: "Ninjomenya Gyukotsuo", ja: "人情麺屋 牛骨王", cat: "food",
  ...
  {
    id: "p-maren", name: "MAREN", ja: "心斎橋", cat: "food",
  ...
  {
    id: "p-gorichan", name: "Onigiri Gorichan", ja: "おにぎりごりちゃん", cat: "food",
  ...
  {
    id: "p-tokito", name: "Tokito", ja: "ときと", cat: "food",
  ...
  {
    id: "p-kitan", name: "Kitan Hibiki", cat: "food",
  ...
  {
    id: "p-joto", name: "Joto Curry", cat: "food",
    area: "osaka", where: "Osaka",
    maps: "Joto Curry Osaka",
    note: ""
  },
  {
    id: "p-itosen", name: "Itosen", cat: "food",
    area: "osaka", where: "Osaka",
    maps: "Itosen Osaka",
  ...
  /* ============================ Matsumoto ============================ */
  {
    id: "p-nakamachi", name: "Nakamachi Street", ja: "中町通り", cat: "shopping",
    area: "matsumoto", where: "Matsumoto",
    maps: "Nakamachi Street Matsumoto",
    note: "Ceramics and homeware in the old kura warehouses."
  },
  {
    id: "p-tsubame", name: "Tsubame Onsen Kogane no Yu", ja: "燕温泉 黄金の湯", cat: "nature",
  ...
  /* ============================ Fuji · Izu ============================ */
  {
    id: "p-odaru", name: "Ō-daru Falls", ja: "大滝", cat: "nature",
  ...
  {
    id: "p-nishina", name: "Nishina Pass", ja: "仁科峠展望台", cat: "nature",
  ...
  {
    id: "p-dogashima", name: "Dōgashima", ja: "堂ヶ島", cat: "nature",
  ...
  {
    id: "p-shiraito", name: "Shiraito Falls", ja: "白糸の滝", cat: "nature",
    area: "fuji", where: "Fujinomiya",
    maps: "白糸の滝 富士宮",
    note: ""
  },
  {
    id: "p-asama", name: "Kawaguchi Asama Shrine", ja: "河口浅間神社", cat: "do",
    area: "fuji", where: "Kawaguchiko",
    maps: "河口浅間神社",
    note: ""
  },
  {
    id: "p-mononoke", name: "Mononoke Forest", cat: "nature",
    area: "fuji", where: "Fujinomiya",
    maps: "Mononoke Forest Japan",
    note: ""
  },
  {
    id: "p-makaino", name: "Makaino Farm Resort", cat: "do",
    area: "fuji", where: "Fujinomiya",
    maps: "まかいの牧場",
    note: ""
  },
  {
    id: "p-moom", name: "MooM Cafe", cat: "coffee",
  ...
  /* ============================ Tokyo ============================ */
  {
    id: "p-t-nakameguro", name: "T", ja: "中目黒", cat: "food",
  ...
  {
    id: "p-marumo", name: "pizza marumo", cat: "food",
    area: "tokyo", where: "Tokyo",
    maps: "pizza marumo Tokyo",
    note: ""
  },
  {
    id: "p-coconemaru", name: "Coco Nemaru Ginza", cat: "food",
    area: "tokyo", where: "Ginza",
    maps: "Coco Nemaru Ginza",
    note: ""
  },
  {
    id: "p-philocoffea", name: "PHILOCOFFEA", ja: "表参道店", cat: "coffee",
    area: "tokyo", where: "Omotesandō",
    maps: "PHILOCOFFEA 表参道店",
    note: ""
  },
  {
    id: "p-melt", name: "Melt Chocolate", cat: "coffee",
    area: "tokyo", where: "Tokyo",
    maps: "Melt Chocolate Tokyo",
    note: ""
  },
  {
    id: "p-travelers", name: "Traveler's Factory", cat: "shopping",
  ...
  {
    id: "p-lelabo", name: "LE LABO", cat: "shopping",
    area: "tokyo", where: "Daikanyama",
    maps: "LE LABO Daikanyama",
    note: ""
  },
  {
    id: "p-yamada", name: "RECORD BAR YAMADA", cat: "do",
    area: "tokyo", where: "Tokyo",
    maps: "RECORD BAR YAMADA Tokyo",
    note: ""
  },
  {
    id: "p-goodmorning", name: "GOOD morning RECORD BAR", cat: "do",
    area: "tokyo", where: "Tokyo",
  ...
  {
    id: "p-lacollina", name: "La Collina Ōmi-Hachiman", cat: "do",
