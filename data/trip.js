...
{d:14,dow:"ד׳",base:"fuji",t:"יום פוג׳י · מודולרי לפי ראות",items:[
  ...
  {c:"water",k:"koganezaki",n:"גרסה D · ⭐ טיול דרכים במערב איזו",s:"07:45 יציאה → 09:30 מפל Ō-daru → 11:20 ホドホドBase בקאוזו (צהריים) → כביש 136 לאורך החוף → 14:30 כף Koganezaki → 16:20 מעבר Nishina · שקיעה 17:16 → ~19:10 חזרה · 215 ק״מ, ~5 שעות נהיגה",opt:1,drive:"fuji_izu_west"},
  {c:"water",k:"jogasaki",n:"גרסה E · איזו מזרחי",s:"Ito (עיירת אונסן לחוף הים) → הר Ōmuro (נוף וולקני) → חוף Jōgasaki (מצוקים) · יום שונה לגמרי",opt:1,drive:"fuji_izu_east"},
  {c:"bath",k:"shuzenji",n:"גרסה E2 · איזו מרכזי",s:"Shuzenji + הטבע והאונסן סביבו, אולי מפלי Joren · קצר וקל יותר",opt:1,drive:"fuji_izu_central"}],
  note:"פוג׳י הוא הר של בקרים — בודקים עננות בערב הקודם ובבוקר, ומחליטים אז. שקיעה ~17:00.",
  note2:"D הוא עכשיו הכיוון המוביל ליום הזה — טיול דרכים ולא ציד אתרים: יער ומפל → קפה מקומי → חוף פראי → מעבר הרים בשקיעה. ארבע עצירות, לא יותר. המעבר לחוף המערבי עובר ליד Shimoda בדרך — עוברים, לא עוצרים.",
  note3:"מפל Ō-daru: מרפסת התצפית ציבורית וחינם, הטיילת פתוחה 08:00–17:00 באוקטובר. הירידה לבריכת המפל עצמה רק דרך AMAGISO (אונסן יומי בתשלום). ホドホドBase: 10:00–16:30, סגור בימי שני — 14/10 יום רביעי, פתוח — אבל רק 4 מקומות חניה, כדאי להגיע לפני 12:00.",
  note4:"כבישים: העלייה מ-Koganezaki למעבר (仁科峠宇久須線) היא הקטע הצר והתלול — 900 מ׳ טיפוס — ועושים אותה באור יום ב-15:55. שתי דרכי החזרה ממשיכות צפונה על הרכס ולא יורדות בחזרה באותו כביש. להימנע מ-旧天城トンネル (מנהרת אמאגי הישנה) — כביש עפר חד-נתיבי שאפליקציות ניווט מציעות לפעמים כאתר תיירות; הנכונה היא המנהרה החדשה בכביש 414."},
