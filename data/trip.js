...
{d:7,dow:"ד׳",base:"kyoto",t:"אוסקה → קוראמה → קיבונה → קיוטו",items:[
  {c:"town",k:"osaka",n:"צ׳ק-אאוט מ-MEANDER",s:"יוצאים עם טרולי קטן בלבד — המזוודות הגדולות כבר ב-MIRU",t:"08:00–08:30"},
  {c:"rail",n:"נמבה → Yodoyabashi → Demachiyanagi",s:"מטרו מידוסוג׳י ל-Yodoyabashi, ואז קייהאן 特急 עד תחנת הקצה · מגיעים 09:30–10:00",k:"demachiyanagi",leg:{mode:"rail",hrs:1.3,txt:"אוסקה → Demachiyanagi"}},
  {c:"rail",n:"לוקרים ב-Demachiyanagi",s:"משאירים כאן את הטרולי · זו גם תחנת הקצה של קייהאן וגם תחנת המוצא של אייזן — חוזרים לכאן ממילא, אז היום נסגר כלולאה",k:"demachiyanagi"},
  {c:"rail",n:"אייזן → Kurama",s:"⚠️ לא יורדים ב-Kibuneguchi — ממשיכים לתחנה האחרונה · מנהרת המייפל על הקו בדרך",t:"~10:15–10:30",k:"kurama",leg:{mode:"rail",hrs:0.5,txt:"Demachiyanagi → Kurama"}},
  {c:"sight",n:"Kurama-dera · עולים מצד קוראמה",s:"09:00–16:15 · משער Niōmon ומעלה דרך חצרות המקדש והיער אל האולם הראשי · עולים ברגל; הרכבל רק אם מזג האוויר או העייפות אומרים אחרת",k:"kuramadera"},
  {c:"walk",n:"חציית ההר אל קיבונה",s:"מהאולם הראשי ממשיכים מעל ההר ויורדים אל קיבונה · 40 דק׳ בקצב מהיר, ~60 בנחת · כיוון אחד — לא חוזרים ל-Kurama",q:"Kurama to Kibune hiking trail"},
  {c:"sight",k:"kifune",n:"Kifune Shrine",s:"מדרגות הפנסים האדומים ואל המקדש הראשי, גורלות המים"},
  {c:"cafe",n:"קיבונה · צהריים, נחל, קפה",s:"אוכל או חטיף ליד המים, קפה אם יש משהו טוב פתוח, שיטוט רגוע · לא הופכים את קיבונה לרשימת אתרים",q:"Kibune Kyoto"},
  {c:"bus",n:"חזרה · אוטובוס 33 → Kibuneguchi",s:"מקיבונה לתחנה, אייזן חזרה ל-Demachiyanagi, אוספים את הטרולי",t:"16:00–17:00",k:"kibuneguchi"},
  {c:"stay",k:"kyoto",n:"MIRU Kyoto Gion · צ׳ק-אין",s:"קייהאן ל-Gion-Shijo ואז הליכה קצרה · מגיעים 17:00–18:00, נחים",leg:{mode:"rail",hrs:0.6,txt:"Demachiyanagi → Gion-Shijo"}},
  ...
  note:"🧳 המזוודות הגדולות נשלחות מ-MEANDER אוסקה ישירות ל-MIRU Kyoto Gion יום-יומיים לפני (5–6/10). ⚠️ לוודא מול MIRU מראש שהם מקבלים ומאחסנים. ב-7.10 נוסעים עם טרולי קטן בלבד.",
  note2:"לוקרים: התוכנית היא Demachiyanagi, כי היום חוזר לשם ממילא. אם מלא — Gion-Shijo יושבת על אותו קו לפניה, אז אפשר לאחסן שם בדרך ולאסוף בחזרה לפני המלון.",
  note3:"⚠️ לאמת קרוב לתאריך: לוח קייהאן, לוח אייזן, לוח אוטובוס 33 מקיבונה, זמינות וגדלים של לוקרים ב-Demachiyanagi, מצב השביל בין קוראמה לקיבונה, שעות וגישה ל-Kurama-dera, ומזג האוויר.",
  note4:"teamLab Biovortex יורד מהיום הזה — נשאר אופציה לפעם אחרת, לא משלבים אותו עם קוראמה. שלכת רק באמצע נובמבר, ועונת ה-kawadoko נגמרת בסוף ספטמבר — ב-7.10 ירוק, בלי פלטפורמות מעל הנחל.",
  note5:"המסלול כולו, כולל הפסקת קפה, הוא בערך 4–5 שעות. Kurama-dera נסגר 16:15, אז ההגעה ב-10:15–10:30 היא מה שמחזיק את היום."},
...
{d:14,dow:"ד׳",base:"fuji",t:"מערב איזו · טיול דרכים",items:[
  {c:"drive",k:"gotemba",n:"יוצאים מ-edit×seven",s:"73.9 ק״מ עד המפל · טומיי → שין-טומיי → כביש 136 → כביש 414 דרך מנהרת אמאגי החדשה וגשר הלולאה",t:"08:30",drive:"fuji_izu_west"},
  {c:"nature",k:"odaru",n:"מפל Ō-daru · 大滝",s:"מרפסת התצפית ציבורית וחינם, הטיילת פתוחה 08:00–17:00 באוקטובר · הירידה לבריכת המפל עצמה רק דרך AMAGISO בתשלום · לא עושים את כל שבעת המפלים — מפל אחד, יער ונחל",t:"~10:05"},
  {c:"cafe",k:"hodohodo",n:"ホドホドBase · קאוזו",s:"צהריים וקפה · 10:00–16:30, סגור בימי שני — 14/10 הוא רביעי · רק 4 מקומות חניה · 静岡県河津町浜75-2 · סגירות לא-קבועות מתפרסמות רק באינסטגרם",t:"~11:30"},
  {c:"drive",n:"חוצים מערבה · כביש 15 ואז 136",s:"42.8 ק״מ עד קוגנזאקי, ~40 דק׳ נהיגה נטו · עוברים ליד שימודה בלי לעצור · Iwachi ו-Dogashima יושבות על כביש 136 בדרך צפונה — עוצרים רק אם מתחשק, לא בתוכנית",q:"Route 136 Nishiizu coast"},
  {c:"water",k:"koganezaki",n:"כף Koganezaki · העצירה בחוף המערבי",s:"מצוקי לבה זהובים מעל מפרץ סורוגה · חניה וכניסה חינם · שבילי מצוק ומרפסות תצפית, 30–40 דק׳ לרוב המבקרים · סלע הסוס · Koganest ליד החניה לשירותים ומשהו קר",t:"~14:00"},
  {c:"nature",k:"nishinatoge",n:"מעבר Nishina · שעת הזהב",s:"14.2 ק״מ טיפוס מהחוף אל ~900 מ׳ · מגיעים 16:15–16:30 — זמן לחנות, לעלות לתצפית ולהיות שם לפני האור, לא בול בשקיעה · שקיעה 17:14",t:"16:15"},
  {c:"drive",k:"gotemba",n:"חזרה · דרך החוף, לא דרך הרכס",s:"יורדים ל-Toi וצפונה על כביש 136 · 99 ק״מ במקום 75 ו-+17 דק׳, אבל חוסך ~25 ק״מ של כביש הרים בחושך · מגיעים ~19:00",t:"~17:30"},
  {c:"nature",k:"panoramadai",n:"גיבוי A · ראות מצוינת לפוג׳י",s:"Panorama-dai → Oshino Hakkai מוקדם → צפון Kawaguchiko → Ōishi Park",opt:1,drive:"fuji_loop"},
  {c:"nature",k:"oshino",n:"גיבוי B · מעונן חלקית",s:"נשארים קרוב: Gotemba, Yamanakako, Oshino, מזרח Kawaguchiko",opt:1},
  {c:"nature",k:"hakone",n:"גיבוי C · פוג׳י מוסתר → Hakone",s:"אגם Ashi, Ōwakudani, המוזיאון הפתוח · הקרוב והקל",opt:1,drive:"fuji_hakone"},
  {c:"water",k:"jogasaki",n:"גיבוי E · איזו מזרחי",s:"Ito → הר Ōmuro → מצוקי Jōgasaki",opt:1,drive:"fuji_izu_east"},
  {c:"bath",k:"shuzenji",n:"גיבוי E2 · איזו מרכזי",s:"Shuzenji והאונסן סביבו, אולי מפלי Joren · קצר וקל יותר",opt:1,drive:"fuji_izu_central"}],
  note:"היום הזה הוא הזרימה, לא האתרים: יער ומפל → קפה מקומי → חוף פראי → מעבר הרים בשקיעה. ארבע עצירות, לא יותר. ~238 ק״מ, ~4:15 נהיגה נטו לפי מדידה — עם עצירות ותנועה תכננו על ~5 שעות מאחורי ההגה.",
  note2:"למה קוגנזאקי ולא Dogashima: Dogashima היא המפורסמת, אבל מה שמייחד אותה — הטומבולו אל Sanshirojima — כמעט אף פעם לא מסתדר עם שעות אור בין אוקטובר לפברואר, והשאר זה שיט מאורגן עם לוח זמנים. קוגנזאקי חינם, בלי כרטיס ובלי שעה, 15 דק׳ מתחת למעבר, ומצוקי הלבה שונים לגמרי מהבוקר ביער. Dogashima ו-Iwachi ממילא על הדרך צפונה אם בא לעצור לעשר דקות.",
  note3:"🛣️ כבישים: הטיפוס מהחוף למעבר הוא כביש הרים צר, ועושים אותו באור יום. בחזרה — הדרך הקצרה ממשיכה על הרכס (כבישים 59 ו-411, ~25 ק״מ הרים בחושך); אנחנו יורדים במקום זה לחוף ב-Toi ועולים צפונה על כביש 136 הלאומי, ואז לאקספרסוויי. ❌ להימנע מ-旧天城トンネル (מנהרת אמאגי הישנה) — כביש עפר חד-נתיבי שאפליקציות ניווט מציעות לפעמים כאתר תיירות; הנכונה היא המנהרה החדשה בכביש 414.",
  note4:"⚠️ לאמת קרוב לתאריך: שעות ההגעה מול תנועה אמיתית, שההודהודו פתוח באותו יום, ושעת השקיעה. פוג׳י הוא הר של בקרים — אם התחזית מצוינת דווקא לפוג׳י, הגיבויים למטה קיימים; אחרת איזו לא תלוי בראות ההר."},
...
var SCREENS = {
  book:{groups:[
    ...
    {label:"⚠️ להזמין — לפי דחיפות",rows:[
      ...
      {icon:"bed",name:"מזוודות MEANDER → MIRU · 5–6/10",sub:"לוודא מול MIRU Kyoto Gion שהם מקבלים ומאחסנים, ואז לשלוח takkyubin יום-יומיים לפני · ב-7.10 נוסעים עם טרולי קטן בלבד",meta:"לוודא",tone:"warn"},
      {icon:"bus",name:"קוראמה–קיבונה · 7/10",sub:"לאמת לוח קייהאן ואייזן, אוטובוס 33 מקיבונה, לוקרים ב-Demachiyanagi, ומצב השביל · Kurama-dera 09:00–16:15",meta:"לאמת",tone:"warn"},
      ...
      {icon:"star",name:"teamLab Biovortex",sub:"ירד מ-7/10 · נשאר אופציה פתוחה ליום אחר אם ייפתח חלון — ¥3,600–5,600, Flexible Pass · לא להזמין עכשיו",meta:"אופציונלי",tone:""}]}]},
